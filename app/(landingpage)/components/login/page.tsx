       ...
       <LabelInputContainer className="mb-4">
        ...
        <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm mb-4">
                    <label htmlFor="newsletter" className="font-light text-gray-500 dark:text-gray-300">I accept the <a className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Forgot Password</a></label>
                  </div>
              </div>
